    ...
    <form class="form-padrao form-dados" method="POST" action="/painel/usuarios/adicionar-usuario" send="/painel/usuarios/adicionar-usuario" >
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {!! Form::select('tipo', ['1' => 'Administrador', '2' => 'Comum'], null, ['class' => 'form-control']) !!}
            </div>

        </div>

        <div class="modal-footer">
            <button type="button" class="btn btn-default btn-lg active" onclick="limparCampos('/painel/usuarios/adicionar');" ><i class="fa fa-trash-o"></i> Limpar</button>
